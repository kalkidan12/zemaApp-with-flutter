...
class _MezmurPageState extends State<MezmurPage> {
  ...
  static List<String> content = [
    ...
    'መልካምነትህን (2) \n በዘመኔ በህይወቴ \n ተረዳችክ ነብስ \n ቀኑን በደመና ለሊቱን በእሳት\n ህዝብን ስትመራ አንተ እግዚአብሔር \n ከአለት አፍልቀህ መናን ከሰማይ \n እጀ ሰፊ ጌታ አንተ ኤልሻዳይ \n ተመስገን(2) \n ተመስገን ልበል \n ክብር የተገባው የተገባው እንዳንተ የሚሆን የለም ዘላለም \n መልካምነትህን(2)\n ያመነክ አብርሃም ተስፋ ያደረገክ \n ሲታይ የማይመስል እንደ ሰው ያልሆነ\n አንተ ያው አንተ ነህ ልክ እንደቃልህ \n እንደ ሰማይ ኮከብ የበዛ በምድር \n ተመስገን(2) \n መልካምነትህን(2) \n ሰንሰለት ያልቻለው የእግር ብረት \n የሌጌዎን ጭፍራ ጥሎት መቃብር \n ስትመጣ በግርማ በታላቅ ሞገስ \n ተፈታ ብስራት ሰጠኸው ሰላምን \n ተመስገን(2) \n በቆሰለው እጅህ ስዳሰስ በደም \n ተፈውሼ ቀረው ከአዳም ህመም \n አሮጊያዘው ያለ ያልሰመነ ከእኔ \n ሊያቀኝ አልቻለም አዲስ በመሆኔ \n\n',
    'አዝ: \n ከልብ የሆነ ምስጋና \n ለሆንከው ትልቅ ገናና \n አቅም ሆነኸን ዛሬን አይተናል \n ክብር ምስጋና ላንተ ይገባኻል \n ምስጋናው ብዙ ነው የፍጥረት ቤዛ \n እርሱ ነው ጌታችን ምሪቱ \n ፍጥረት ላሰበሰበው ይመሰገናል \n ለለታው ብዛት ቃል አተውለታል \n\n አዝ: \n\n ሞተን ነበርን በበደላችን \n እስክታገኝ አንተ ጌታችን \n ባይገባን እንኳን ህይወት ማግኘት \n ባንተ አመለጥን ከዘላለም ሞት \n \n አዝ: \n\n ክበር ከዘላለም እስከ ዘላለም \n አባት የሚሆን እንዳተ የለም \n የተለየህ ነህ ቸሩ የኛ አምላክ \n በሠማይ በምድር የሌለህ ምትክ \n\n አዝ: \n\n  እንግዲህ እንዘምር ከበሮ እንምታ \n የሃዘን ማቅ ቀዶ ላለበሰ ደስታ \n ትልቅ የከበረ ሃይል እንበለው \n ምስጋና የተገባው ለዘላለም ቸር ነው \n\n'
  ];
