...
class _RulePageState extends State<RuleDrawer> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text("ህግና ደንብ", style: TextStyle(fontSize: 17),),
